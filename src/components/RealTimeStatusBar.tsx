...
export default function RealTimeStatusBar({ className = '' }: RealTimeStatusBarProps) {
  ...
  // Geçici mock data
  const adminNotifications = { unreadCount: 0, notifications: [] };
  const restaurantNotifications = { unreadCount: 0, notifications: [] };
  const userNotifications = { unreadCount: 0, notifications: [] };
